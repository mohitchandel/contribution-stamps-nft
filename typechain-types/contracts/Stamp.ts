...
export interface StampInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "mintedLanguages",
    values: [AddressLike, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [string, ClaimRequestStruct, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Stamp extends BaseContract {
  connect(runner?: ContractRunner | null): Stamp;
  ...
  mintedLanguages: TypedContractMethod<
  ...
  safeMint: TypedContractMethod<
    [uri: string, _claimRequest: ClaimRequestStruct, _language: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "mintedLanguages"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [boolean],
    "view"
