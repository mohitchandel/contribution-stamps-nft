...
function StampFunc() {
  ...
  const mintStamp = async () => {
    ...
    const config = await prepareWriteContract({
      ...
      args: [
        "https://bafkreiakrdpg4jgikugbr6mktmdpntloyowl5mppb7ht7ykl7p54lr5p34.ipfs.nftstorage.link/",
        mintData,
        languagesIndexes.JavaScript,
      ],
    });
      ...
      <>
        ...
        <Row justify="center" gutter={[16, 16]}>
          <Col span={10}>
            ...
            <Title level={2}>JavaScript Stamp</Title>
            <Text>
              Mint a unique JavaScript stamp by providing details about your
              GitHub repository showcasing your JavaScript projects. Fill in the
...
export default function jsStamp() {
  return (
    <WagmiWrapper>
      <StampFunc />
    </WagmiWrapper>
